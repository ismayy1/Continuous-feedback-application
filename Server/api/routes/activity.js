...
router.put('activities/aid', async(req, res, next) => {
  try {
    ...
    if(activity) {
      ...
      res.status(200).json({message: 'update succefful!'});
    } else{
...
router.put('/activities/:aid/update-count-emoji1', async(req, res, next) => {
  try {
    ...
    if(activity) {
      ...
      //res.status(200).json(activity)
      res.status(200).json({message: 'updated succesfully count_emoji1!'});
    } else {
      res.status(400).json({message: 'Not Found :('});
    }
  } catch(err) {
  ...
  try {
    ...
    if(activity) {
      let updated = {
        ...
        "count_emoji2": activity.count_emoji2 + 2,
        "count_emoji3": activity.count_emoji3,
        "count_emoji4": activity.count_emoji4,
        "professorId": activity.professorId
      }
      await activity.update(updated);
      //res.status(200).json(activity)
      res.status(200).json({message: 'updated succesfully count_emoji2!'});
    } else {
      res.status(400).json({message: 'Not Found :('});
    }
  } catch(err) {
  ...
  try {
    ...
    if(activity) {
      let updated = {
        ...
        "count_emoji1": activity.count_emoji1,
        "count_emoji2": activity.count_emoji2,
        "count_emoji3": activity.count_emoji3 + 3,
        "count_emoji4": activity.count_emoji4,
        "professorId": activity.professorId
      }
      await activity.update(updated);
      //res.status(200).json(activity)
      res.status(200).json({message: 'updated succesfully count_emoji3!'});
    } else {
      res.status(400).json({message: 'Not Found :('});
    }
  } catch(err) {
  ...
  try {
    ...
    if(activity) {
      let updated = {
        ...
        "count_emoji2": activity.count_emoji2,
        "count_emoji3": activity.count_emoji3,
        "count_emoji4": activity.count_emoji4 + 4,
        "professorId": activity.professorId
      }
      await activity.update(updated);
      //res.status(200).json(activity)
      res.status(200).json({message: 'updated succesfully count_emoji4!'});
    } else {
      res.status(400).json({message: 'Not Found :('});
    }
  } catch(err) {
